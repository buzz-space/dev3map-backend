...
use Botble\Blog\Repositories\Caches\CommentCacheDecorator;
use Botble\Blog\Repositories\Eloquent\CommentRepository;
...
class BlogServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(CommentInterface::class, function () {
            return new CommentCacheDecorator(new CommentRepository(new PostComment));
        });
    }
...
//                ->registerItem([
//                    'id'          => 'cms-plugins-blog-comment',
//                    'priority'    => 3,
//                    'parent_id'   => 'cms-plugins-blog',
//                    'name'        => 'plugins/blog::comment.name',
//                    'icon'        => null,
